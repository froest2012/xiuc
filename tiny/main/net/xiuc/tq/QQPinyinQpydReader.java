...
public class QQPinyinQpydReader {
    public static void main(String[] args) throws IOException {
        ...
        String qqydFile = "/Users/xiuc/qypd" + File.separator + "汽车灯光升级专用词汇.qpyd";
        ...
        System.out.println("压缩数据：" +Integer.toHexString(startZippedDictAddr) + " (解压前：" + zippedDictLength
        ...
        while (unzippedDictStartAddr == -1 || idx < unzippedDictStartAddr) {
            ...
            if (unzippedDictStartAddr == -1) {
                ...
                System.out.println("词库地址（解压后）："+Integer.toHexString(unzippedDictStartAddr) + "\n");
            }
